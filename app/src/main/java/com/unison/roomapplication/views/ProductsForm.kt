...
@Composable
fun ProductsForm(navController: NavController, viewModel: ProductosViewModel, modifier: Modifier = Modifier) {
    ...
    Box(
        ...
        Column {
            FormHeader(navController)
            FormBody(
                onSaveProduct = { name: String, description: String, price: String, date: String ->

                    viewModel.onEvent(ProductoEvent.CreateProducto(name, description, price, date))
...
//                    navController.navigate(NavDestinations.ProudctsList.route)
            ...
            Snackbar(content = { Text(text = "Producto creado")}, )
        }
    }
}

@Composable
fun FormHeader(navController: NavController,modifier: Modifier = Modifier) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .background(
...
@Composable
fun GoBackArrow(navController: NavController, modifier: Modifier = Modifier) {
    Box(
        modifier = Modifier
            .size(50.dp)
            .offset(5.dp, 5.dp)
        ...
        FloatingActionButton(
            onClick = {  navController.navigate(NavDestinations.ProudctsList.route) },
